$(function () {
  var radarOptions = {
    palette: "soft",
    dataSource: dataSource1[0].values,
  ...
  var radar = $("#radarChart1")
    .dxPolarChart(radarOptions)
    .dxPolarChart("instance");

  $("#radarPeriods1").dxSelectBox({
    width: 300,
    dataSource: dataSource1,
    displayExpr: "period",
    valueExpr: "values",
    value: dataSource1[0].values,
...
$(function () {
  var radarOptions = {
    palette: "soft",
    dataSource: dataSource2[0].values,
    title: "Wind Rose, Philadelphia PA",
    commonSeriesSettings: {
      type: "stackedbar",
    },
  ...
  var radar = $("#radarChart2")
    .dxPolarChart(radarOptions)
    .dxPolarChart("instance");

  $("#radarPeriods2").dxSelectBox({
    width: 300,
    dataSource: dataSource2,
    displayExpr: "period",
    valueExpr: "values",
    value: dataSource2[0].values,
    onValueChanged: function (e) {
      radar.option("dataSource", e.value);
    },
  });
